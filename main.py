...
import pandas as pd
import joblib
from tensorflow.keras.models import load_model # Menggunakan TensorFlow
import numpy as np
...
# --- BAGIAN 3: INISIALISASI APLIKASI DAN MEMUAT MODEL ---
app = FastAPI(title="API Prediksi Kualitas Tidur (TensorFlow)", version="6.1.0")
app.add_middleware(CORSMiddleware, allow_origins=["*"], allow_credentials=True, allow_methods=["*"], allow_headers=["*"])

# ===== TAMBAHAN ENDPOINT ROOT UTAMA =====
@app.get("/", tags=["Root"])
def read_root():
